...
export default function Footer() {
  ...
  return (
    <footer className="relative mt-12">
      <div className="bg-[#0a1628] rounded-t-[2rem] overflow-hidden">
        <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12 pt-14 pb-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-7 gap-8 mb-10">
            ...
            {footerColumns.map((col) => (
              <div key={col.title}>
                <h4 className="text-slate-300 font-bold text-xs uppercase tracking-wider mb-4">
                  {col.title}
                </h4>
          ...
          <div className="flex flex-col lg:flex-row lg:items-center gap-6 lg:gap-5 flex-wrap">
            {/* Language Selector */}
            <button className="flex items-center gap-2 px-4 py-2 rounded-full border border-white/15 text-slate-300 hover:border-blue-400/50 hover:text-white transition-colors text-sm whitespace-nowrap">
            ...
            <div className="flex items-center gap-2.5">
              <motion.a
                ...
                whileTap={{ scale: 0.95 }}
                aria-label="Facebook"
                className="w-9 h-9 rounded-lg border border-white/15 flex items-center justify-center text-slate-300 hover:text-blue-400 hover:border-blue-400/50 transition-colors"
              >
            ...
            <div className="flex items-center gap-6 flex-wrap">
              {stats.map((stat) => (
                <div key={stat.label} className="flex flex-col items-center text-center">
                  <stat.icon className="w-4 h-4 text-blue-400 mb-1" strokeWidth={1.5} />
                  <span className="text-white font-bold text-sm leading-tight">{stat.value}</span>
            ...
            <a
              href="#"
              className="flex items-center gap-2.5 px-4 py-2 rounded-lg bg-white/5 border border-white/15 hover:border-blue-400/50 transition-colors whitespace-nowrap"
            >
              ...
              <div className="flex flex-col leading-tight">
                <span className="text-slate-400 text-[9px] uppercase tracking-wide">Get it on</span>
                <span className="text-white text-sm font-semibold">Google Play</span>
              </div>
            </a>

            {/* Copyright */}
            <p className="text-slate-500 text-xs lg:ml-auto whitespace-nowrap">
