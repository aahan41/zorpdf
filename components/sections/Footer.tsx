...
export default function Footer() {
  return (
    <footer className="bg-[#050913] px-4 sm:px-6 pb-8">
        ...
        <div className="px-6 sm:px-8 lg:px-10 py-10 lg:py-12">
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8 lg:gap-10">
            ...
            {footerLinks.map((group) => (
              <div key={group.title}>
                <h3 className="text-white font-bold text-sm mb-4 tracking-wide">{group.title}</h3>
          ...
          <div className="mt-10 pt-8 border-t border-white/10 flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6">
              ...
              <div className="flex items-center gap-3">
                {socialLinks.map((social) => (
                  <a
                    ...
                    className="w-10 h-10 rounded-xl border border-white/10 bg-white/[0.03] flex items-center justify-center text-slate-400 hover:text-white hover:border-blue-400/40 hover:bg-blue-500/10 transition-all"
                  >
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-5">
              <a
                href="#"
                className="inline-flex items-center gap-3 rounded-xl border border-white/30 px-4 py-2.5 text-white hover:bg-white/5 transition-colors"
                aria-label="Get it on Google Play"
              >
                <Play className="w-6 h-6 fill-white" />
                <span className="leading-none">
                  <span className="block text-[10px] uppercase tracking-wide text-slate-300">Get it on</span>
