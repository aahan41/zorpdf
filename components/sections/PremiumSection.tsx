...
import { Crown, Zap, ShieldCheck, UploadCloud, Sparkles } from "lucide-react";

export default function PremiumSection() {
  return (
    <section className="bg-[#050913] px-4 sm:px-6 py-16">
      <div className="max-w-7xl mx-auto overflow-hidden rounded-3xl border border-yellow-500/25 bg-gradient-to-br from-[#111827] via-[#0b1120] to-[#050913] shadow-2xl shadow-yellow-950/20">
        <div className="grid lg:grid-cols-2 gap-10 items-center p-6 sm:p-10 lg:p-14">
          ...
          <div>
            ...
            <p className="text-slate-400 text-base sm:text-lg leading-relaxed max-w-xl mb-8">
              Abhi ZorPDF free hai. Jaldi hi premium users ke liye zyada file limit,
              faster conversion, priority support aur advanced PDF tools available honge.
            </p>
            ...
            <div className="grid sm:grid-cols-2 gap-4 mb-8">
              {[
                ...
                <div
                  key={item.title}
                  className="rounded-2xl border border-white/10 bg-white/[0.04] p-4 hover:border-yellow-400/30 transition"
                >
          ...
          <div className="relative">
            ...
            <div className="relative rounded-3xl border border-yellow-400/20 bg-[#0b1120] p-6 shadow-2xl">
              <div className="rounded-2xl bg-gradient-to-br from-yellow-300 to-orange-500 p-1">
