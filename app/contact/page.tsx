    ...
    <div className="min-h-screen bg-[#0d1117] text-white">
      <div className="max-w-2xl mx-auto px-6 py-16">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-gray-400">Koi sawaal hai? Hum help karne ke liye tayyar hain!</p>
        </div>
        ...
        <div className="grid grid-cols-2 gap-4 mb-8">
          {[
            ...
            <div key={item.title} className="bg-[#161b22] border border-[#30363d] rounded-xl p-5 text-center">
        ...
        {sent ? (
          <div className="bg-green-900/30 border border-green-800 rounded-xl p-8 text-center">
            ...
            <p className="text-gray-400 text-sm mb-6">Hum jald hi aapse sampark karenge.</p>
            <Link href="/" className="bg-blue-600 hover:bg-blue-700 px-6 py-2 rounded-lg text-sm transition">
              Home pe Wapas Jao
            </Link>
          </div>
        ) : (
          <div className="bg-[#161b22] border border-[#30363d] rounded-xl p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                <label className="text-sm text-gray-400 mb-1 block">Aapka Naam</label>
                <input
                  type="text"
                  required
                  value={form.name}
